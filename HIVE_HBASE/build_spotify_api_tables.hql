...
with serdeproperties("hbase.columns.mapping"=":key,x:artist_name,x:track_name,x:track_id,x:popularity,x:year_");   

insert into  hbase_dsl.track_details_hb(select 
    id,
    artist_name,
    track_name,
    track_id,
